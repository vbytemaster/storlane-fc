...
| secp256k1 | `secp256k1/` vendored library and current K1 tests | Keep K1 signing/recovery on specialized `secp256k1`; OpenSSL 3 migration must not alter canonical K1 behavior. | Replacing K1 with OpenSSL ECDSA or changing recoverable signature format. | `fcl::ecc` K1 path. | K1 recovery and string roundtrip tests. |
