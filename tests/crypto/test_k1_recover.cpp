...
namespace std {
std::ostream& operator<<(std::ostream& st, const std::variant<fcl::k1_recover_error, bytes>& err) {
   if (std::holds_alternative<fcl::k1_recover_error>(err))
      st << static_cast<int32_t>(std::get<fcl::k1_recover_error>(err));
   else
...
BOOST_AUTO_TEST_CASE(recover) try {
   ...
   using test_k1_recover = std::tuple<std::string, std::string, std::variant<fcl::k1_recover_error, bytes>>;
   const std::vector<test_k1_recover> tests{
       ...
       {"01174de755b55bd29026d626f7313a5560353dc5175f29c78d79d961b81a0c04360d833ca789bc16d4ee714a6d1a19461d890966e0ec5c"
        ...
        "45fd65f6dd062fe7020f11d19fe5c35dc4d425e1479c0968c8e932c208f25399", fcl::k1_recover_error::invalid_signature},
       ...
       {"174de755b55bd29026d626f7313a5560353dc5175f29c78d79d961b81a0c04360d833ca789bc16d4ee714a6d1a19461d890966e0ec5c07"
        "4f67be67e631d33aa7",
        "45fd65f6dd062fe7020f11d19fe5c35dc4d425e1479c0968c8e932c208f25399", fcl::k1_recover_error::input_error},
       ...
       {"00174de755b55bd29026d626f7313a5560353dc5175f29c78d79d961b81a0c04360d833ca789bc16d4ee714a6d1a19461d890966e0ec5c"
        "074f67be67e631d33aa7",
        "fd65f6dd062fe7020f11d19fe5c35dc4d425e1479c0968c8e932c208f25399", fcl::k1_recover_error::input_error},
   ...
   for (const auto& test : tests) {
      ...
      auto res = fcl::k1_recover(signature, digest);
