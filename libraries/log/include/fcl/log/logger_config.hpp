...
FCL_REFLECT( fcl::appender_config, (name)(type)(args) )
FCL_REFLECT( fcl::logger_config, (name)(level)(enabled)(appenders) )
FCL_REFLECT( fcl::logging_config, (includes)(appenders)(loggers) )
