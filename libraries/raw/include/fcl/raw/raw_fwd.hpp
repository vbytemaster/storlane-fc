...
namespace fcl {
   ...
   namespace raw {
    ...
    template<typename Stream, typename Storage> inline void pack( Stream& s, const fcl::fixed_string<Storage>& u );
    template<typename Stream, typename Storage> inline void unpack( Stream& s, fcl::fixed_string<Storage>& u );
   ...
   template<typename Stream, NotTrivialScalar T, std::size_t S> inline void unpack( Stream& s, std::array<T,S>& value );
    ...
    template<typename Stream, typename T> void unpack( Stream& s, fcl::safe<T>& v );
    ...
    template<typename Stream> void unpack( Stream& s, fcl::ecc::public_key& );
    template<typename Stream> void pack( Stream& s, const fcl::ecc::public_key& );
    template<typename Stream> void unpack( Stream& s, fcl::ecc::private_key& );
    template<typename Stream> void pack( Stream& s, const fcl::ecc::private_key& );
   ...
   template<typename Stream, TrivialScalar T, std::size_t N> inline void pack( Stream& s, const fcl::array<T,N>& v);
   template<typename Stream, NotTrivialScalar T, std::size_t N> inline void pack( Stream& s, const fcl::array<T,N>& v);
   template<typename Stream, TrivialScalar T, std::size_t N> inline void unpack( Stream& s, fcl::array<T,N>& v);
   template<typename Stream, NotTrivialScalar T, std::size_t N> inline void unpack( Stream& s, fcl::array<T,N>& v);
