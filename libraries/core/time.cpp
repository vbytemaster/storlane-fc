...
#include <fcl/core/mock_time.hpp>
...
namespace fcl {
  ...
  time_point time_point::now()
  {
     if( UNLIKELY(mock_time_traits::is_set()) ) {
        return mock_time_traits::fcl_now();
     }
  ...
  { try {
      ...
      return fcl::time_point_sec( (pt - epoch).total_seconds() );
  } FCL_RETHROW_EXCEPTIONS( warn, "unable to convert ISO-formatted string to fcl::time_point_sec" ) }
  ...
  } FCL_RETHROW_EXCEPTIONS( warn, "unable to convert ISO-formatted string to fcl::time_point" ) }

  void to_variant( const fcl::time_point& t, variant& v ) {
    v = t.to_iso_string();
  }
  void from_variant( const fcl::variant& v, fcl::time_point& t ) {
    t = fcl::time_point::from_iso_string( v.as_string() );
  }
  void to_variant( const fcl::time_point_sec& t, variant& v ) {
    v = t.to_iso_string();
  }
  void from_variant( const fcl::variant& v, fcl::time_point_sec& t ) {
    t = fcl::time_point_sec::from_iso_string( v.as_string() );
  }
  ...
  std::string get_approximate_relative_time_string(const time_point_sec& event_time,
                                                   const time_point_sec& relative_to_time /* = fcl::time_point::now() */,
  ...
  std::string get_approximate_relative_time_string(const time_point& event_time,
                                                   const time_point& relative_to_time /* = fcl::time_point::now() */,
