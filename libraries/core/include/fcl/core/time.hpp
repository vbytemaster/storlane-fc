...
namespace fcl {
  ...
  class variant;
  void to_variant( const fcl::microseconds&,  fcl::variant&  );
  void from_variant( const fcl::variant& , fcl::microseconds& );
  ...
  class time_point_sec
  {
    public:
        ...
        constexpr time_point to_time_point()const { return time_point( fcl::seconds( utc_seconds) ); }
  ...
  std::string get_approximate_relative_time_string(const time_point_sec& event_time,
                                                   const time_point_sec& relative_to_time = fcl::time_point_sec{fcl::time_point::now()},
...
FCL_REFLECT_TYPENAME( fcl::time_point )
FCL_REFLECT_TYPENAME( fcl::microseconds )
FCL_REFLECT_TYPENAME( fcl::time_point_sec )
