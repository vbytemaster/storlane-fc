...
namespace fcl { namespace crypto { namespace r1 {
    ...
    namespace {
      ...
      evp_pkey_ptr make_private_pkey(const private_key_secret& secret)
      {
        ...
        FCL_ASSERT(1 == OSSL_PARAM_BLD_push_utf8_string(builder.get(), OSSL_PKEY_PARAM_GROUP_NAME,
                                                       r1_group_name, 0));
      ...
      std::optional<public_key_data> recover_public_key_from_sig(ECDSA_SIG* sig, const fcl::sha256& digest, int recid, bool check)
      {
