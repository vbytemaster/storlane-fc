...
class public_key {
   public:
      using public_key_data_type = fcl::array<char, 33>;
...
class signature {
   public:
      ...
      friend struct fcl::reflector<signature>;
...
FCL_REFLECT(fcl::crypto::webauthn::signature, (compact_signature)(auth_data)(client_json))