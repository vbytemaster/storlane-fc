...
namespace fcl::crypto::blslib {
   ...
   public:
      ...
      // Could use FCL_REFLECT, but to make it obvious serialization matches bls_aggregate_signature implement via operator
      template<typename T>
   ...
   public:
      ...
      // Could use FCL_REFLECT, but to make it obvious serialization matches bls_signature implement via operator
      template<typename T>
